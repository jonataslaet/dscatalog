...
public class ProductResourceIT {
	...
	void findAllShouldReturnSortedPage0Size3WhenSortedByNameDesc() throws Exception {
		ResultActions request = mockMvc.perform(get("/products?page=0&size=3&sort=name,desc").accept(MediaType.APPLICATION_JSON));
	...
	void findAllShouldReturnSortedPage1Size3WhenSortedByNameDesc() throws Exception {
		ResultActions request = mockMvc.perform(get("/products?page=1&size=3&sort=name,desc").accept(MediaType.APPLICATION_JSON));
	...
	void findAllShouldReturnSortedPage2Size3WhenSortedByNameDesc() throws Exception {
		ResultActions request = mockMvc.perform(get("/products?page=2&size=3&sort=name,desc").accept(MediaType.APPLICATION_JSON));
	...
	void findAllShouldReturnSortedPage0Size3WhenSortedByNameAsc() throws Exception {
		ResultActions request = mockMvc.perform(get("/products?page=0&size=3&sort=name,asc").accept(MediaType.APPLICATION_JSON));
	...
	void updateProductShouldProductDTOWhenIdExists() throws Exception {
		...
		ResultActions request = mockMvc.perform(put("/products/{id}", existingId).content(jsonBody).contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON));
	...
	void updateProductShouldReturnNotFoundWhenIdDoesNotExist() throws Exception {
		...
		ResultActions request = mockMvc.perform(put("/products/{id}", nonExistingId).content(jsonBody).contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON));
